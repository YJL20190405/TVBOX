...
detailUrl:'/x/web-interface/view?aid=fyid',searchUrl:'/x/web-interface/search/type?search_type=video&keyword=**&page=1',searchable:2,quickSearch:0,headers:{"User-Agent":"PC_UA","Referer":"https://www.bilibili.com",
   // 示例：使用DanmuPlayer库实现基础弹幕
   import: DanmuPlayer, from: 'danmuplayer',

   const: danmu = new DanmuPlayer({
     container: '#video-container', // 视频容器ID
     url: 'https://api.bilibili.com/x/v1/dm/list.so?oid=1329940574', // 弹幕数据API
     speed: 15000,                  // 弹幕移动速度
     maxCount: 50,                  // 最大同时显示弹幕数
   }),
   danmu:init(),
